  ...
  return (
    <div className="about-us-container" id="aboutus">
      ...
      <div className="about-us-text">
        ...
        (sculpture, carpenter, cartographer, draftsman,etc...) but also in
        different fields such as marketing, architecture, design and branding.
        <br />
        ...
        environmental specificities of the resin. Our project started as a dream
        that is now becoming reality. Cedroxy will be reflecting, in each unique
        piece, Lebanese beauty using different species of trees that grow around
        this region.
      </div>
    </div>
  );
